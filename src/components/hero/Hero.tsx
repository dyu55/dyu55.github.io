...
// SVG components for missing icons
const GitHubIcon = () => (
      ...
      <div className="max-w-6xl mx-auto w-full py-20 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-medium bg-[var(--color-surface)] border border-[var(--color-border)] text-[var(--color-muted-foreground)]">
              <span className="w-2 h-2 rounded-full bg-[var(--color-accent)] animate-pulse" />
              Available for opportunities
            </div>

            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-[var(--color-text)] leading-[1.1]">
              AI Systems
              <br />
              <span className="text-[var(--color-accent)]">Engineer</span>
            </h1>

            <p className="text-lg sm:text-xl text-[var(--color-text-secondary)] max-w-xl leading-relaxed">
              I build production AI systems — RAG pipelines, agentic architectures,
              and the infrastructure that makes them reliable. Previously at
              [Company], building AI products at scale.
            </p>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="p-6 rounded-xl bg-[var(--color-surface)] border border-[var(--color-border)]">
              <div className="text-3xl font-bold text-[var(--color-text)]">4</div>
              <div className="text-sm text-[var(--color-muted-foreground)] mt-1">
                Projects shipped
              </div>
            </div>
            <div className="p-6 rounded-xl bg-[var(--color-surface)] border border-[var(--color-border)]">
              <div className="text-3xl font-bold text-[var(--color-text)]">140+</div>
              <div className="text-sm text-[var(--color-muted-foreground)] mt-1">
                RAG tests
              </div>
            </div>
            <div className="p-6 rounded-xl bg-[var(--color-surface)] border border-[var(--color-border)]">
              <div className="text-3xl font-bold text-[var(--color-text)]">7k+</div>
              <div className="text-sm text-[var(--color-muted-foreground)] mt-1">
                Concurrent users
              </div>
            </div>
            <div className="p-6 rounded-xl bg-[var(--color-surface)] border border-[var(--color-border)]">
              <div className="text-3xl font-bold text-[var(--color-text)]">2yr</div>
              <div className="text-sm text-[var(--color-muted-foreground)] mt-1">
                AI/agent focus
              </div>
            </div>
